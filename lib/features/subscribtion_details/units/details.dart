          ...
          ListView.builder(
             ...
             //   print(UpdateProfileCubit.get(context).subscriptionData.userDetails!.firstName);
                List detail = [
                  ...
                  (UpdateProfileCubit.get(context).subscriptionData.subscriptionDetails==null?'Not Found':UpdateProfileCubit.get(context).subscriptionData.subscriptionDetails!.subscriptionTakenOn.toString()),
                  ...
                  (UpdateProfileCubit.get(context).subscriptionData.subscriptionDetails==null?'Not Found':UpdateProfileCubit.get(context).subscriptionData.subscriptionDetails!.stripeId.toString()),
                  'Card Payment',
                  'xxxx-xxxx-xxxx-4242',
                  '',
                ];
