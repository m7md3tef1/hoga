          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(child: CustomButton(function: ()=>Navigator.pop(context,false), text: 'No',height: 40.sp,font: 15)),
                SizedBox(width: 35.sp,),
                Expanded(child: CustomButton(function: ()=>MagicRouter.navigateAndPopAll(Login()), text: 'Yes',height: 40.sp,font: 15,)),
                SizedBox(width: 35.sp,),
